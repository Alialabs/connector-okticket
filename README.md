...
<p align="center">
  <a href="https://www.odoo.com"><img src="https://img.shields.io/badge/Odoo-16.0-714B67" alt="Odoo 16.0"/></a>
...
- **Categorías** — crea en Odoo un producto de gasto por cada categoría de OkTicket, incluidas
  las variantes facturables, y **rellena su tabla de impuestos** con los criterios del IVA español
...
El conector reúne los gastos importados en **hojas de gasto**. Tres módulos añaden ese flujo por
encima de la importación:
...
cada tipo comparten grupo y cuenta.

Por eso el conector escribe él mismo la tabla de impuestos de cada producto, con lo que dice la
Ley 37/1992 para esa categoría: 10 % de servicios en un taxi, 21 % de **bienes** en un repostaje,
0 % exento en un vuelo internacional y 0 % **no sujeto** en un tren transfronterizo. Se rellena en
cada sincronización de productos, solo crea lo que falta y no vuelve a tocar lo que haya editado una
persona.

El [manual técnico](okticket_connector/docs/manual-tecnico.md#10-impuestos-de-los-gastos-importados)
detalla los criterios categoría por categoría, con su base legal, y lo que queda deliberadamente
fuera: la categoría *Otros*, las categorías propias del cliente, los gastos no deducibles y los
territorios con IGIC o IPSI.
...
# dependencias OCA
git clone --branch 16.0 https://github.com/OCA/connector.git
git clone --branch 16.0 https://github.com/OCA/queue.git
...
Una rama por versión de Odoo: `19.0`, `18.0`, `16.0`, `16.0`, `15.0`, `14.0`, `12.0`, `10.0`.
