...
class HrExpense(models.Model):
    ...
    # 'account_move_id' en singular: el campo pasa a ser un One2many
    # ('account_move_ids') en 17.0, asi que la dependencia de la version
    # superior no existe aqui y el registro no carga.
