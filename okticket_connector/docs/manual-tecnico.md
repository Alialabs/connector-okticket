...
<h1 align="center">Conector OkTicket para Odoo 17 · Manual técnico</h1>

<p align="center">
  Instalación, dependencias, configuración del conector y planificación de las sincronizaciones.<br>
  <sub>Módulos <b>17.0.1.0.x</b> · Odoo <b>17.0</b> · Licencia <b>AGPL-3</b> · Rama <code>17.0</code></sub>
</p>

> 📄 **Versión maquetada:** [descargar PDF](https://gitlab.alialabs.com/odoo/connector-okticket/-/raw/17.0-fix-okticket_connector-review/okticket_connector/docs/manual-tecnico.pdf?inline=false)
...
- Una instancia de **Odoo 17.0** (Community o Enterprise) sobre PostgreSQL.
...
El repositorio mantiene una rama por versión de Odoo. Para 17.0:

```bash
git clone --branch 17.0 https://github.com/Alialabs/connector-okticket.git
```
...
Ambos repositorios en su rama `17.0`:
...
<p align="center">
  ...
  <sub>Conector OkTicket para Odoo 17 · Licencia AGPL-3</sub>
</p>
