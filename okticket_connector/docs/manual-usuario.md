...
<h1 align="center">Conector OkTicket para Odoo 16 · Manual de usuario</h1>

<p align="center">
  Qué hace el conector en tu día a día y dónde encontrar cada cosa en Odoo.<br>
  <sub>Para usuarios de Odoo <b>16.0</b> · No requiere conocimientos técnicos</sub>
</p>

> 📄 **Versión maquetada:** [descargar PDF](https://gitlab.alialabs.com/odoo/connector-okticket/-/raw/16.0-fix-okticket_connector/okticket_connector/docs/manual-usuario.pdf?inline=false)
...
Verás que algunas categorías aparecen duplicadas con un sufijo: **-Invoiceable** y
**-Rebillable**, o **-Factura** y **-Refacturable** si quien lanzó la primera sincronización tenía
Odoo en español. Son las variantes que se usan cuando el documento es una factura o un gasto
...
**Viene rellenada.** El conector la escribe él mismo con lo que dice la normativa española para cada
categoría, y la mantiene al día en cada sincronización. Un producto *Taxi* nace sabiendo que un 10 %
es transporte de viajeros, y uno de *Gasolina* sabiendo que su 21 % es una compra de bienes y no un
servicio.

Las filas que ha escrito el conector llevan marcada la casilla **Propuesto por el conector**. Si
alguien cambia el impuesto de una, esa marca desaparece y el conector **no vuelve a tocarla**: el
criterio de la empresa manda a partir de ahí.

> [!NOTE]
> Hay dos casos en los que la tabla llega vacía a propósito: la categoría **Otros**, que es un cajón
> de sastre donde cualquier propuesta sería inventada, y las **categorías que haya creado tu
