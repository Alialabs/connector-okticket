...
<h1 align="center">Conector OkTicket para Odoo 17 · Manual de usuario</h1>

<p align="center">
  Qué hace el conector en tu día a día y dónde encontrar cada cosa en Odoo.<br>
  <sub>Para usuarios de Odoo <b>17.0</b> · No requiere conocimientos técnicos</sub>
</p>

> 📄 **Versión maquetada:** [descargar PDF](https://gitlab.alialabs.com/odoo/connector-okticket/-/raw/17.0-fix-okticket_connector-review/okticket_connector/docs/manual-usuario.pdf?inline=false)
...
Verás que algunas categorías aparecen duplicadas con un sufijo (por ejemplo **-Factura** o
**-Refacturable**). Son las variantes que se usan cuando el documento es una factura o un gasto
